...
<div class="row">
    <div class="card w-100">
        <div class="card-body p-4">
            ...
            "bxssUser" ||session()->get('user')->roles[0]->name == "authority" ||session()->get('user')->roles[0]->name
            == "sender")
            <div class="row">
            ...
            <div class="table-responsive text-capitalize">
                <table id="table" data-filter-control-multiple-search="true"
                    ...
                    data-url="{{route('request.getMediaStaff',$id)}}" data-row-style="rowStyle"
                    data-header-style="headerStyle" data-print-as-filtered-and-sorted-on-ui="true">
                    <thead>
                        <tr>
...
<script>
    ...
    function operateDelete(value, row, index) {
        if (row.media_staff_security_status == 'pending') {
            let params = `'${row.media_uid}','${value}'`;
            return [
                '<div class="left">',
    ...
    function deleteStaff(id, staffId) {
        ...
        axios.post(`/mediaGroup/${id}/deleteMediaStaffRequest/${staffId}`)
