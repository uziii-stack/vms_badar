                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        <livewire:module-search-component wire:id="{{rand()}}" wire:key="{{rand()}}"
                            :className="$modelClass=App\Models\OrganizationStaff::class"
                            :classAssocName="$modelAssocClass=App\Models\Organization::class"
                            :searchParams="['staff_first_name','staff_last_name','staff_identity','staff_contact']"
                            :renderComponent="['staff_first_name','company_name','staff_designation','staff_identity','staff_contact','company_rep_email','code']"
                            searchAssocParams="company_uid" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="d-flex col-md-1 col-sm-2">
        <div class="card overflow-hidden">
            <div class="card-body p-4">
                <h5 class="card-title text-center mb-9 fw-semibold">Total</h5>
    ...
    <div class="d-flex col-md-1 col-sm-2">
        <div class="card overflow-hidden">
            <div class="card-body p-4">
                <h5 class="card-title text-center mb-9 fw-semibold">Functionary </h5>
                <h4 class="d-flex justify-content-center mb-9 fw-semibold">
                    {{$FunctionaryCount}}
                </h4>
            </div>
    ...
    <div class="d-flex col-md-1 col-sm-2">
        <div class="card overflow-hidden">
            <div class="card-body p-4">
                <h5 class="card-title text-center mb-9 fw-semibold">Temporary </h5>
                <h4 class="d-flex justify-content-center mb-9 fw-semibold">
                    {{$TemporaryCount}}
                </h4>
            </div>
    ...
    @foreach ($stats->last() ?? [] as $key=>$item)
    @if($key!='entity_name' && $key !='uid' && $key !='total')
    <div class="d-flex col-md-{{$key !='sent' ? '2':'1'}} col-sm-2">
        <div class="card overflow-hidden text-capitalize">
            <div class="card-body p-4">
                <h5 class="card-title text-center mb-9 fw-semibold">{{$key}}</h5>
                <h4 class="d-flex justify-content-center mb-9 fw-semibold">
                    {{$item}}
                </h4>
            </div>
                ...
                <table id="table" data-filter-control-multiple-search="true"
                    ...
                    <thead>
                        <tr>
                            ...
                            session()->get('user')->roles[0]->name == 'printer'|| session()->get('user')->roles[0]->name
                            == 'sender'|| session()->get('user')->roles[0]->name == 'authority')
